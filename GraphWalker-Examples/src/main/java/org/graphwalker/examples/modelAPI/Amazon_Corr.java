...
public class Amazon_Corr extends org.graphwalker.multipleModels.ModelAPI {
  WebDriver driver = null;

  public Amazon_Corr(File model, boolean efsm, PathGenerator generator, boolean weight) {
